...
function paralax(){
    return(
        <div className="paralax">
          ...
          <div className="wave9" ><svg viewBox="0 0 500 150" preserveAspectRatio="none" className="wave10">
             <path d="M-24.60,26.94 C149.21,110.81 271.49,-49.99 500.22,40.75 L500.00,0.00 L0.00,0.00 Z" className="wave11"></path></svg>
         </div>
